...
- Location: Room G-228 (in person) and virtually on **[Zoom](https://cispa-de.zoom-x.de/meeting/register/QvE86yQJR3aL4RqRFAIeHg)** (registration required). The off-line discussion on [Piazza](https://piazza.com/cispa.de/fall2025/ipml101)
- Exam dates:
