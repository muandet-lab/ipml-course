...
This course has been developed in part based on knowledge and insights gained through the [SIPTA School](https://sipta.org/events/sipta-school/). Some of the foundational lectures draw inspiration from materials developed for [ST790: Imprecise-Probabilistic Foundations of Statistics & Data Science](https://wolfware.ncsu.edu/notice/wordpress-courses2223.wolfware.ncsu.edu/st-790-001-fall-2022/) by [Ryan Martin](https://www4.stat.ncsu.edu/~rgmarti3/), [Uncertainty Representation and Reasoning (2AMU30)](https://dai.win.tue.nl/courses/2AMU30/) by [Erik Quaeghebeur](https://research.tue.nl/en/persons/erik-quaeghebeur/) and Vu-Linh Nguyen, and [Theory of Belief Functions: Application to Machine Learning and Statistical Inference](https://www.hds.utc.fr/~tdenoeux/dokuwiki/en/bf) by [Thierry Denoeux](https://cv.hal.science/tdenoeux). We gratefully acknowledge these excellent resources and their authors.

We are also deeply grateful for countless insightful discussions and personal exchanges with researchers including Gert de Cooman, Erik Quaeghebeur, Jasper De Bock, Michelle Caprio, Siu Lun Chau, Jeremie Houssineau, Julian Rodemann, Fabio Cuzzolin, Eyke Hüllermeier, Bob Williamson, Rajeev Verma, Rabanus Derr, Shireen Manchingal, Yusuf Sale, and many others. We apologize to anyone we have inadvertently omitted.
